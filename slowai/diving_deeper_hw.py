...
# %% auto 0
__all__ = ['pipe', 'get_simple_pipe', 'get_stable_diffusion', 'StableDiffusionWithNegativePromptA',
           'StableDiffusionWithNegativePromptB', 'StableDiffusionWithNegativePromptC']
...
# %% ../nbs/01_diving_deeper_homework.ipynb 12
